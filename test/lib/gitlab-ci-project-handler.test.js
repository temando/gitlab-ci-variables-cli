...
import { gitlabCIProjectHandler } from '../../src/lib/gitlab-ci-project-handler'
...
describe('gitlab-ci-project-handler', () => {
  ...
  it('list variables', async () => {
    ...
    const handler = gitlabCIProjectHandler('https://src.temando.io/khoa.tran/temando-field-manual-tome', gitlabToken)
